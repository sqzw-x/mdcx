...
def remove_escape_string(filename: str, replace_char: str = "") -> str:
    return remove_escape_string1(filename, manager.config_v1.escape_string_list, replace_char)


def deal_actor_more(actor: str) -> str:
    actor_name_max = int(manager.config_v1.actor_name_max)
    actor_name_more = manager.config_v1.actor_name_more
