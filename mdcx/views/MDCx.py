...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_skip_success_file.sizePolicy().hasHeightForWidth())
        self.checkBox_skip_success_file.setSizePolicy(sizePolicy)
        self.checkBox_skip_success_file.setMinimumSize(QtCore.QSize(0, 0))
        self.checkBox_skip_success_file.setObjectName("checkBox_skip_success_file")
        self.verticalLayout_4.addWidget(self.checkBox_skip_success_file)
        self.horizontalLayout_163 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_163.setObjectName("horizontalLayout_163")
        self.label_2 = QtWidgets.QLabel(self.gridLayoutWidget_19)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_163.addWidget(self.label_2)
        self.checkBox_skip_success_file_except = QtWidgets.QCheckBox(self.gridLayoutWidget_19)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_skip_success_file_except.sizePolicy().hasHeightForWidth())
        self.checkBox_skip_success_file_except.setSizePolicy(sizePolicy)
        self.checkBox_skip_success_file_except.setMinimumSize(QtCore.QSize(0, 0))
        self.checkBox_skip_success_file_except.setObjectName("checkBox_skip_success_file_except")
        self.horizontalLayout_163.addWidget(self.checkBox_skip_success_file_except)
        self.verticalLayout_4.addLayout(self.horizontalLayout_163)
        self.horizontalLayout_133.addLayout(self.verticalLayout_4)
        self.checkBox_record_success_file = QtWidgets.QCheckBox(self.gridLayoutWidget_19)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_record_success_file.sizePolicy().hasHeightForWidth())
        self.checkBox_record_success_file.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_133.addItem(spacerItem)
...
"")
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QtCore.QRect(0, 0, 760, 2800))
...
"                first_folder_name （指待刮削目录下第一层子文件夹名，是动态的名字）"))
        ...
        self.checkBox_skip_success_file_except.setText(_translate("MDCx", "更新、读取模式下不跳过"))
