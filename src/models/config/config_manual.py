class ManualConfig:
    ...
    # 定义配置值类型
    INT_KEY = ['version', 'thread_number', 'thread_time', 'javdb_time', 'main_mode', 'soft_link', 'success_file_move', 'failed_file_move', 'success_file_rename',
               'del_empty_folder', 'show_poster', 'folder_name_max', 'file_name_max', 'actor_name_max', 'cd_name', 'pic_name', 'trailer_name', 'use_database',
               'poster_mark', 'thumb_mark', 'fanart_mark', 'mark_size', 'timeout', 'retry', 'rest_count', 'statement', 'actor_photo_kodi_auto', 'auto_link', ]
    FLOAT_KEY = ['file_size', 'clean_size',

                 ]

    # 支持的网站, 用于支持自定义域名
    SUPPORTED_WEBSITES = ['7mmtv', 'airav', 'airav_cc', 'avsex', 'avsox', 'cnmdb', 'dahlia', 'dmm', 'faleno', 'fantastica', 'fc2', 'fc2club', 'fc2hub', 'freejavbt',
                          'getchu', 'giga', 'iqqtv', 'jav321', 'javday', 'javbus', 'javdb', 'javlibrary', 'kin8', 'love6', 'lulubar', 'madouqu', 'mdtv', 'hscangku',
                          'cableav', 'mgstage', 'mywife', 'prestige', 'theporndb', 'xcity']
    ...
    repl_list = ['HEYDOUGA', 'CARIBBEANCOM', 'CARIB', '1PONDO', '1PON', 'PACOMA', 'PACO', '10MUSUME', '-10MU', 'Tokyo Hot', 'Tokyo_Hot', 'TOKYO-HOT', 'TOKYOHOT', '(S1)',
                 '[THZU.CC]', '「麻豆」', '(', ')', '.PRT', 'MP4-KTR', 'rarbg', 'WEBDL', 'x2160x', 'x1080x', 'x2160p', 'x1080p', 'x264 aac', 'x264_aac', 'x264-aac',
                 'x265 aac', 'x265_aac', 'x265-aac', 'H.264', 'H.265', 'DVDRIP', 'DVD ', '2160P', '1440P', '1080P', '960P', '720P', '540P', '480P', '360P', '4096x2160',
                 '1920x1080', '1280x720', '960x720', '640x480', '4096×2160', '1920×1080', '1280×720', '960×720', '640×480', '90fps', '60fps', '30fps', '.cht', '.chs', ]
    web_dic = {
        'airav.io': 'airav_cc',
        'airav.wiki': 'airav',
        '9sex': 'avsex',
    ...
    char_list = ['[高清] (中文字幕)', '[高清 (中文字幕)', ' (中文字幕)', ' (中文字幕)', '[高清中文字幕]', '[高清中文字幕', '高清中文字幕]', '【高清中文字幕】', '[高清]',
                 '无码流出版', '无码流出', '无码破解版', '无码破解', 'TOKYO-HOT-', '韩文转译版', '独家听译版', '完整版', '特别版', '完全版', '时间轴修复版',
                 '导演剪辑最终版', '堂友', ]
    all_key_word = ['title', 'originaltitle', 'outline', 'originalplot', 'series', 'director', 'studio', 'publisher']
    all_rep_word = {'&amp;': '＆',  # 将网页中存在二次抓取的&amp;(实际意义为&)的字符全局替换成＆（大写的&，不会被emby误判，显示更美观）
    ...
    chinese_rep_word = {'姊': '姐',  # 中文简体常见错字全局替换
                        '著': '着',  # 中文简体常见错字全局替换
                        '慾': '欲',  # 中文简体常见错字全局替换
                        '肏': '操',  # 中文简体常见错字全局替换
                        '裡': '里',  # 中文简体常见错字全局替换
    ...
    show_key = ['number', 'letters', 'has_sub', 'cd_part', 'mosaic', 'title', 'originaltitle', 'actor', 'outline', 'originalplot', 'tag', 'release', 'year', 'runtime',
                'score', 'wanted', 'series', 'director', 'studio', 'publisher', 'trailer', 'website', 'javdbid']
    full_half_char = [(u"・", u"·"), (u"．", u"."), (u"，", u","), (u"！", u"!"), (u"？", u"?"), (u"”", u'"'), (u"’", u"'"), (u"‘", u"`"), (u"＠", u"@"), (u"＿", u"_"),
                      (u"：", u":"), (u"；", u";"), (u"＃", u"#"), (u"＄", u"$"), (u"％", u"%"), (u"＆", u"&"), (u"（", u"("), (u"）", u")"), (u"‐", u"-"), (u"＝", u"="),
                      (u"＊", u"*"), (u"＋", u"+"), (u"－", u"-"), (u"／", u"/"), (u"＜", u"<"), (u"＞", u">"), (u"［", u"["), (u"￥", u"\\"), (u"］", u"]"), (u"＾", u"^"),
                      (u"｛", u"{"), (u"｜", u"|"), (u"｝", u"}"), (u"～", u"~"), (u"ａ", u"a"), (u"ｂ", u"b"), (u"ｃ", u"c"), (u"ｄ", u"d"), (u"ｅ", u"e"), (u"ｆ", u"f"),
                      (u"ｇ", u"g"), (u"ｈ", u"h"), (u"ｉ", u"i"), (u"ｊ", u"j"), (u"ｋ", u"k"), (u"ｌ", u"l"), (u"ｍ", u"m"), (u"ｎ", u"n"), (u"ｏ", u"o"), (u"ｐ", u"p"),
                      (u"ｑ", u"q"), (u"ｒ", u"r"), (u"ｓ", u"s"), (u"ｔ", u"t"), (u"ｕ", u"u"), (u"ｖ", u"v"), (u"ｗ", u"w"), (u"ｘ", u"x"), (u"ｙ", u"y"), (u"ｚ", u"z"),
                      ...
                      (u"Ｕ", u"U"), (u"Ｖ", u"V"), (u"Ｗ", u"W"), (u"Ｘ", u"X"), (u"Ｙ", u"Y"), (u"Ｚ", u"Z"), (u"０", u"0"), (u"１", u"1"), (u"２", u"2"), (u"３", u"3"),
                      (u"４", u"4"), (u"５", u"5"), (u"６", u"6"), (u"７", u"7"), (u"８", u"8"), (u"９", u"9"), (u"　", u" ")]
    special_word = {
        '強●': '強制',
        '犯●': '犯さ',
        '凌●': '凌辱',
    ...
    actress_wiki_keywords = ['AV idol', 'pornographic', 'pornoactrice', 'Japanese idol', 'Japanese actress', 'AV actress', 'porn star', 'gravure', 'director',
                             'voice actor', 'gravure idol', 'model', 'Porn actresses']
