...
class GeneratedConfig:
    ...
    website_fc2 = r"fc2,fc2club,fc2hub,fc2ppvdb,freejavbt,7mmtv,hdouban,javdb,avsox,airav"
    ...
    openai_key = r''
    openai_model = r'gpt-4o-mini'
    openai_url = r'https://api.openai.com/v1/chat/completions'
