...
def get_tv_jp_data(real_url):
    ...
    result, response = post_json("https://api.tv.dmm.co.jp/graphql", headers=headers, json=data)
...
def get_tv_com_data(number):
    ...
    result, response = post_json("https://api.tv.dmm.com/graphql", headers=headers, json=data)
    if result and response.get("data"):
