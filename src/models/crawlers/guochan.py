...
def get_lable_list():
    return ["麻豆传媒", "91茄子", "Ed Mosaic", "HongKongDoll", "JVID", "MINI传媒", "SA国际传媒", "TWAV", "乌鸦传媒",
            ...
            "扣扣传媒", "抖阴传媒", "星空无限传媒", "映秀传媒", "杏吧传媒", "果冻传媒", "模密传媒", "爱污传媒",
            "爱神传媒",
            "爱豆传媒", "狂点映像", "猛料原创", "猫爪影像", "皇家华人", "精东影业", "糖心VLOG", "维秘传媒", "草莓视频",
            "萝莉社",
            "蜜桃传媒", "西瓜影视", "起点传媒", "香蕉视频", "PsychoPorn色控", "蜜桃影像传媒", "大番号番啪啪",
            "REAL野性派", "豚豚创媒",
            "宫美娱乐", "肉肉传媒", "爱妃传媒", "91制片厂", "O-STAR", "兔子先生", "杏吧原创", "杏吧独家", "辣椒原创",
            "麻豆传媒映画", "红斯灯影像",
            "绝对领域", "麻麻传媒", "渡边传媒", "AV帝王", "桃花源", "蝌蚪传媒", "SWAG", "麻豆", "杏吧", "糖心",
            "国产短视频", "国产精品", "国产AV", "涩会"]


def get_actor_list():
    return ['Madison Summers', 'Spencer Bradley', 'Madison Morgan', 'Rosalyn Sphinx', 'Braylin Bailey',
            'Whitney Wright', 'Victoria Voxxx', 'Alexia Anders',
            'Bella Rolland', 'Violet Myers', 'Sophia Leone', 'Violet Starr', 'Eliza Ibarra', 'HongKongDoll',
            'Keira Croft', 'April Olsen', 'Avery Black',
            'Amber Moore', 'Anny Aurora', 'Skylar Snow', 'Harley Haze', 'Paige Owens', 'Vanessa Sky', 'MasukuChan',
            'Kate Bloom', 'Kimmy Kimm', 'Ana Foxxx',
            'Lexi Luna', 'Gia Derza', 'Skye Blue', 'Nico Love', 'Alyx Star', 'Ryan Reid', 'Kira Noir', 'Karma Rx',
            '下面有根棒棒糖', 'Vivian姐', 'COLA酱',
            'cola醬', 'Stacy', 'ROXIE', '真木今日子', '小七软同学', 'Chloe', 'Alona', '小日向可怜', 'NANA', '玩偶姐姐',
            '粉色情人', '桥本香菜', '冉冉学姐', '小二先生',
            '饼干姐姐', 'Rona', '不见星空', '米娜学姐', '阿蛇姐姐', '樱花小猫', '樱井美里', '宸荨樱桃', '樱空桃桃',
            '牛奶泡芙', '91兔兔', '棉花糖糖', '桥本爱菜',
            '许木学长', 'MOMO', '驯鹿女孩', '高梨遥香', 'DORY', '冬月结衣', 'Aida', '香菜公主', '藤田美绪', '浅尾美羽',
            '天音美纱', '中条爱莉', '三月樱花', 'Emma',
            'Vita', '千夜喵喵', '水原圣子', '白川麻衣', '池田奈美', '西村莉娜', 'A天使爱', '中野惠子', '麻衣CC',
            '樱桃空空', 'LENA', '小泽纱香', '木下日葵', '中岛芳子',
            '弥生美月', '逢见梨花', '宇佐爱花', '沙月芽衣', '羽月萌音', '前田由美', '伊东爱瑠', 'Misa', '绿帽先生',
            '莉娜乔安', '柚木结爱', '黑田奈奈', '神山奈奈',
            '孟若羽', '夏晴子', '吴梦梦', '沈娜娜', '李蓉蓉', '林思妤', '仙儿媛', '金宝娜', '季妍希', '温芮欣',
            '吴文淇', '苏语棠', '秦可欣', '吴芳宜', '李娜娜',
            '乐奈子', '宋南伊', '小水水', '白允儿', '管明美', '雪千夏', '苏清歌', '玥可岚', '梁芸菲', '白熙雨',
            '小敏儿', '楚梦舒', '柚子猫', '姚宛儿', '宋雨川',
            '舒可芯', '苏念瑾', '白沛瑶', '林沁儿', '唐雨菲', '李允熙', '张芸熙', '寻小小', '白靖寒', '钟宛冰',
            '李薇薇', '米菲兔', '雷梦娜', '董悦悦', '袁子仪',
            '赖畇希', '王以欣', '夏禹熙', '狐不妖', '凌波丽', '黎芷萱', '陆斑比', '辛尤里', '小猫咪', '顾桃桃',
            '南芊允', '岚湘庭', '林芊彤', '梁佳芯', '林凤娇',
            '明日香', '绫波丽', '邓紫晴', '赵一曼', '吴茜茜', '锅锅酱', '倪哇哇', '潘雨曦', '吴恺彤', '美杜莎',
            '郭童童', '陈可心', '莫夕慈', '沈芯语', '董小宛',
            '苏艾文', '翁雨澄', '赵晓涵', '小桃酱', '宋东琳', '香月怜', '李文雯', '白若冰', '徐夜夜', '真希波',
            '爱丽丝', '张宇芯', '金善雅', '李依依', '苏安亚',
            '奶咪酱', '白葵司', '罗瑾萱', '宁洋子', '小夜夜', '白晶晶', '张雅婷', '吴心语', '林曼芸', '项子甯',
            '吳芳宜', '苏小小', '文冰冰', '韩宝儿', '白星雨',
            '林怡梦', '张欣妍', '七濑恋', '白思吟', '吴凯彤', '溫芮欣', '林可菲', '黎芷媗', '御梦子', '苏雨彤',
            '古伊娜', '聂小倩', '陈圆圆', '沙美辰', '林妙可',
            '乐淆雪', '李恩娜', '周晴晴', '杨思敏', '李曼妮', '戚小怜', '谢语彤', '王筱璐', '卢珊珊', '程诗诗',
            '林玥玥', '白瞳瞳', '魏乔安', '米胡桃', '施子涵',
            '北野爱', '杜冰若', '玛丽莲', '胡蓉蓉', '万静雪', '花语柔', '萧悦儿', '林晓雪', '兰心洁', '神谷怜',
            '唐雨霏', '鸡蛋饼', '沈湘妮', '费爵娜', '小美惠',
            '大奶露', '向若云', '苏小沫', '榨汁姬', '陈星然', '夏雨荷', '姚彤彤', '莫云雪', '艾瑞卡', '黄雪纯',
            '赵雅琳', '叶宸欣', '伊琬琳', '陈美惠', '金巧巧',
            '陈美琳', '陆思涵', '顾小北', '陈小雨', '维里娜', '兔小白', '叶子红', '美凉子', '李丹彤', '李微微',
            '白婷婷', '艾米酱', '刘小姗', '白童童', '张琪琪',
            'Yua', '小玩子', '岚可彤', '都可可', '李慕儿', '叶一涵', '赵佳美', '董小婉', '钟丽琪', '韩小雅', '杨朵儿',
            '叶梦语', '程雨沫', '张曼青', '纪妍希', '伊婉琳',
            '凌雨萱', '潘甜甜', '美竹玲', '韩依人', '奈奈子', '林雪漫', '宋甜甜', '陆雪琪', '宋妮可', '陆子欣',
            '范可可', '许依然', '苏小新', '蒋梦琳', '李可欣',
            '小鹿酱', '小林杏', '陶杏儿', '明步奈', '苏宁儿', '白潼潼', '增田枫', '特污兔', '何安汝', '倪菀儿',
            '唐可可', '口罩酱', '小千绪', '糖糖儿', '许安妮',
            '李婧琪', '刘思慧', '欧阳晶', '欧美玲', '林亦涵', '钟以彤', '许书曼', '付妙菱', '伊靖瑶', '张娅庭',
            '韩小野', '宫泽蓝', '冯思雨', '林小樱', '刘颖儿',
            '莫潇潇', '胡心瑶', '林雨露', '苏婧薇', '许月珍', '陈若瑶', '吴芮瑜', '叶如梦', '刘依依', '吴语菲',
            '张妮妮', '林子涵', '张子瑜', '周卿卿', '李师师',
            '苏语堂', '方紫璐', '袁采菱', '刘清韵', '李曼丽', '刘小雯', '姬咲华', '高小颜', '蔡晓雨', '梁如意',
            '林语桐', '王小妮', '唐月琴', '星谷瞳', '何小丽',
            '张婉妍', '酒井爱', '张秀玲', '晚晚酱', '薛梦琪', '李乐乐', '张佳晨', '程媛媛', '沐语柔', '安琪拉',
            '韩倪希', '苏妲己', '白佳萱', '刘语珊', '徐韵珊',
            '糖果屋', '顾伊梦', '赵颖儿', '莫安安', '黎星若', '林予曦', '蒋佑怡', '王有容', '李恩琦', '赵美凤',
            '徐筱欣', '黄雅曼', '菲于娜', '金丞熙', '叶凡舒',
            '郭瑶瑶', '李嘉欣', '袁庭妮', '林思好', '张云熙', '李忆彤', '伊蒂丝', '沙耶香', '美雪樱', '王亦舒',
            '李文静', '鸡教练', '斑斑', '坏坏', '糖糖', '艾秋',
            '凌薇', '莉娜', '韩棠', '苡若', '尤莉', '优娜', '林嫣', '徐蕾', '周甯', '唐茜', '香菱', '佳芯', '湘湘',
            '米欧', '斑比', '蜜苏', '小婕', '艾熙', '娃娃',
            '艾玛', '雪霏', '夜夜', '欣欣', '乔安', '羽芮', '美酱', '师师', '玖玖', '橙子', '晨曦', '苏娅', '黎儿',
            '晨晨', '嘉洛', '小遥', '苏畅', '琪琪', '苡琍',
            '李慕', '心萱', '昀希', '黎娜', '乐乐', '樱桃', '桐桐', '苏璇', '安娜', '悠悠', '茉莉', '宛冰', '静静',
            '丝丝', '菲菲', '樱樱', '波妮', '唐芯', '小野',
            '何苗', '甜心', '瑶瑶', '小捷', '薇薇', '美樱', '宁静', '欧妮', '吉吉', '小桃', '绯丽', '嘉琪', '咪妮',
            '雯茜', '小洁', '李琼', '唐霏', '岚玥', '熙熙',
            '米娅', '舒舒', '斯斯', '欣怡', '妍儿', '阿雅', '宋可', '畇希', '柔伊', '雅沁', '惠敏', '露露', '艾悠',
            '娜娜', '李娜', '肖云', '王玥', '林洋', '清洛',
            '艾鲤', '依涵', '半雪', '琦琦', '莎莎', '小冉', '琳怡', '莉奈', '梅子', '啤儿', '瑶贝', '杨柳', '童汐',
            '米亚', '琳达', '晴天', 'KK', '紫宸', '淑怡',
            '花花', '金铭', '程葳', '妍希', '咪妃', '茜茜', '小蜜', '凌萱', '觅嫣', '涵涵', '欲梦', '美琳', '杜鹃',
            '许诺', '兮兮', '白鹿', '虞姬', '丽萨', '蔷薇',
            '小影', '优优', '茶茶', '可儿', '甜甜', '憨憨', '波尼', '依颂', '依依', '思思', '芳情', '月牙', '小爱',
            '淳儿', '苗方', '茶理', '苹果', '苏然', '陶子',
            '董欣', '羽熙', '清沐', '林襄', '娃诺', '洁咪', '小昭', '球球', '紫萱', '南兰', '安琪', '可乐', '夏露',
            '诗琪', '陈韵', '丽娜', '苏旋', '月月', '石榴',
            '米兰', '恩恩', '西子', '芷萱', '酥酥', '王茜', '千鹤', '雪见', '姜洁', '张晴', '辰悦', '丁香', '白颖',
            '穆娜', '小芳', '吉娜', '秋霞', '无双', '夏宝',
            '舒涵', '小柔', '小小', '璇元', '米砂', '余丽', '美嘉', '莉莉', '奈奈', '黑糖', '晴子', '多乙', '徐婕',
            '闵闵', '小雪', '洋洋', '明儿', '苏茜', '芯怡',
            '姚茜', '百合', '婉婷', '小乔', '芽芽', '婕珍', '乔乔', '紫寒', '小薇', '菜菜', '洁米', '夏天', '灵枝',
            '语伊', '徐艳', '王佩', '希汶', '雅捷', '喵喵',
            '尤奈', '仙儿', '氖氖', '蔚曼', '田恬', '颂潮', '小婵', '千凌', '李燕', '林芳', '杨桃', '艾莉', '落落',
            '冯雪', '王蓉', '妖妖', '雨晨', '心雪', '穆雪',
            '韩焉', '邱月', '檀雅', '柯柯', '七七', '鱼儿', '丹丹', '简一', '淑仪', '小哇', '朵儿', '妲己', '云朵',
            '唐菲', '邦妮', '白英', '夏夏', '安安', '小艺',
            '丽丽', '敏敏', '空空', '椿芽', '小言', '李蕊', '水水', '小鱼', '艾艾', '尹媚', '夏滢', '琳希', '王欣',
            '洛雪', '李茹', '娜米', '萱萱', '肖泳']
